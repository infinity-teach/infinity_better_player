...
class BetterPlayerBufferingConfiguration {
  ...
  static const defaultMinBufferMs = 25000;  /// min 25 seconds
  static const defaultMaxBufferMs = 6553600; /// max 6553.6 seconds -- 109 min
  static const defaultBufferForPlaybackMs = 3000;   /// 3 seconds
  static const defaultBufferForPlaybackAfterRebufferMs = 6000;  /// 6 seconds
